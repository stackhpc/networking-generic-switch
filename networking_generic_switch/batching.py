...
class SwitchQueue(object):
    ...
    def add_batch(self, cmds):
        ...
        :return: a 2-tuple containing the UUID and etcd create revision.
        """
        ...
        # TODO: Refactor this into a more opaque context object that can be
        # passed back to SwitchQueue methods?
        return uuid, create_revision

    def wait_for_result(self, uuid, start_revision, timeout):
        """Wait for the result of a command batch.

        :param uuid: UUID returned by add_batch
        :param start_revision: revision returned by add_batch
...
class SwitchBatch(object):
    ...
    def do_batch(self, device, cmd_set, timeout=300):
        ...
        uuid, create_revision = self.queue.add_batch(cmd_list)
        ...
        output = self.queue.wait_for_result(uuid, create_revision, timeout)
